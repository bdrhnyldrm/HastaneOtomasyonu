...
namespace WebApplication2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(DatabaseContext databaseContext, IConfiguration configuration, LanguageService localization)
        {
		...
		public IActionResult Login()
        {
            ...
            ViewBag.Hospital = _localization.Getkey("Hospital").Value;
